    ...
    <table width="100%" border="0" cellspacing=0 cellpadding=2 class="tform">
        ...
        <tr>
            ...
            <td>
                ...
                </select><span style="font-style: italic; color: #808080; padding-left: 5px;">Includes all users who have access via department or user groups.</span>
                 <?}else {?>
                       No Users (Add Users)
        ...
        <tr><th>Email Templates:</th>
            <td>
                <select name="tpl_id">
                    ...
                    <?
                    $templates=LNF::getDeptTemplates();
