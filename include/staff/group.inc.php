...
<table width="100%" border="0" cellspacing=0 cellpadding=0>
 ...
 <tr><td>
    <table width="100%" border="0" cellspacing=0 cellpadding=2 class="tform">
        ...
        <tr><th>Receive New Ticket Alerts</th>
            <td>
              <input type="radio" name="group_new_ticket_alerts"  value="1" <?=$info['group_new_ticket_alerts']?'checked':''?> />Yes
              <input type="radio" name="group_new_ticket_alerts"  value="0" <?=!$info['group_new_ticket_alerts']?'checked':''?> />No
              &nbsp;&nbsp;<i>Send new ticket alerts to group members.</i>
            </td>
        </tr>
    </table>
